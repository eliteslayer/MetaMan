...
public class FileNavigator {
	 ...
	 * @throws FileNotFoundException if the new directory does not exist
	 */
	public void changeDirectory(String newDirectory) throws FileNotFoundException{
		...
		if(tempFile.exists()){
			...
			throw new FileNotFoundException("File Does Not Exist: " + newDirectory);
		}
	}
	
	/**
	 * Changes the current file to its parent if it exits otherwise the current file remains the same.
	 ...
	 * If the operation is successful then the currentFile is in the Directory that it was moved to.
	 * @param destinationDirectory The Directory to be moved to
	 * @return true if it was successfully moved
	 * @throws IOException
	 */
	public boolean moveCurrentFile(String destinationDirectory) throws IOException{
